...
#define	DLX_MEMSIZE_ADDRESS	0xffff0000 // 4 GB = 2^32
...
#define	MEMORY_L1_PAGE_SIZE_BITS 16	// each entry in L1 is 4 bytes (pointers)
#define	MEMORY_L2_PAGE_SIZE_BITS 16
