...
if __name__ == "__main__":
    ...
    for m in module_masses:
        ...
        ff = calculate_fuel_required_for_fuel(fm)  # part2 of day1 puzzle
        print("Fuel required for fuel of mass %s is %s" % (fm, ff))
        fuel_for_modules += fm
        fuel_for_fuel += ff

    print("Fuel required for modules excl. fuel mass: %s" % fuel_for_modules)
    print("Fuel required for fuel mass: %s" % fuel_for_fuel)
